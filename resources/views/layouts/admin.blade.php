...
<body class="pace-done" data-layout-mode="light" data-topbar="light" data-sidebar="light"
    data-layout-scrollable="true" data-layout-size="fluid">
        ...
        <header id="page-topbar">
            <div class="navbar-header">
                <div class="d-flex">
                    ...
                    <button type="button" class="btn btn-sm btn-sm px-3 font-size-16 header-item"
