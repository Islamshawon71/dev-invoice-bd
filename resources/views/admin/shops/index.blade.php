    ...
    <div class="card-header">
        <div class="row">
            <div class="col-lg-6 col-6">
                Total <span class="count">0</span> {{ trans('cruds.shop.title_singular') }} {{ trans('global.list') }}
            </div>
...
{ data: 'shop_phone_number', name: 'shop_phone_number' },
{ data: 'shop_logo', name: 'shop_logo', sortable: false, searchable: false },
