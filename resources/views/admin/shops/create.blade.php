    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.shops.store") }}" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('shop_address') ? 'is-invalid' : '' }}" type="text" name="shop_address" id="shop_address" value="{{ old('shop_address', '') }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('shop_phone_number') ? 'is-invalid' : '' }}" type="text" name="shop_phone_number" id="shop_phone_number" value="{{ old('shop_phone_number', '') }}" required>
