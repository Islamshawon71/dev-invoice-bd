...
@section('content')
    ...
    <div class="card">
        <div class="card-header">
            <div class="row">
                <div class="col-lg-6">
                    Total <span class="count">0</span> {{ trans('cruds.order.title_singular') }}
                    {{ trans('global.list') }}
                </div>
                <div class="col-lg-6">
                    @can('order_create')
        ...
        <div class="card-body">
            <table
                class=" table table-bordered dt-responsive  nowrap w-100 table-hover ajaxTable datatable datatable-Order">
                <thead>
                    <tr>
                        <th width="10">
